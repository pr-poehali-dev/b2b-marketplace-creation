...
const About = () => {
  ...
  const milestones = [
    { year: "2024", title: "Основание", description: "Создание компании и разработка первой версии платформы" },
    { year: "2025", title: "Запуск платформы", description: "Выход на рынок и привлечение первых поставщиков и клиентов" },
    { year: "2026", title: "Масштабирование", description: "Расширение географии присутствия и рост партнёрской сети по всей России" }
  ];
