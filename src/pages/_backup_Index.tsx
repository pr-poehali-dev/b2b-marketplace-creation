// БЭКАП главной страницы (была на роуте "/").
// Раздел "Главная" убран из меню, а всё её содержимое перенесено в /catalog (см. src/pages/Catalog.tsx).
// Этот файл НЕ подключён в App.tsx и ни на что не влияет — хранится на случай, если понадобится вернуть всё как было.
// Чтобы восстановить: верните маршрут "/" на этот компонент в src/App.tsx и верните пункт "Главная" в меню
// (src/components/header/SidebarNavigation.tsx и src/components/header/MobileMenu.tsx).
