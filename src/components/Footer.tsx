        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-lg opacity-90">
              Интегрируйтесь с BizNexus для оптимизации всех закупочных процессов. 
              Консалтинг включен.
            </p>
      ...
      <footer id="contacts" className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold">BizNexus</span>
              </div>
              <p className="text-gray-400 text-sm">
                Корпоративная платформа для автоматизации закупок и управления цепями поставок.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-400">
            <p>© 2024 BizNexus. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </>
