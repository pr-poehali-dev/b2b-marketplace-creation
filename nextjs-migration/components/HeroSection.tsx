        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start lg:items-center">
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-5">
              <Button
                size="lg"
                className="text-base sm:text-lg h-12 sm:h-14 w-full sm:w-auto font-semibold"
              ...
              {images.map((image, index) => (
                <img
                  ...
                  className={`w-full h-full absolute top-0 left-0 ${
                    index === 0 ? 'object-contain bg-white p-8' : 'object-cover transition-all duration-1000 ease-in-out'
                  } ${
